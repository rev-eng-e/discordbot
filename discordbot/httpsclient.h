...
public:
    ...
    inline static QString urlEncode(QString str)
    {
        ...
        char c,bufHex[10];
        int ic;
        std::string non_encoded_str=str.toUtf8().toStdString();
        const char *chars=non_encoded_str.c_str();
...
public:
    ...
    void generate()
    {
        ...
        else if(!cookiecontainer::cookies.isEmpty())
            headers+="Cookie: "+cookiecontainer::cookies+"\r\n";
                ...
                if(response.headers.contains("Transfer-Encoding: chunked"))
                {
                    ...
                    do
                    {
                        ...
                        if(readyRead())
                        {
                            ...
                            if(r > 0)
                                response.content.resize(contentsize+r);
                            else
